	<%@page import="kr.or.ddit.review.service.IReviewService"%>
	<%@page import="kr.or.ddit.review.service.ReviewService"%>
	<%@page import="kr.or.ddit.review.vo.ReviewVO"%>
	<%@ page language="java" contentType="text/html; charset=UTF-8"
		pageEncoding="UTF-8"%>
	<%  
			String resNo = (String)request.getParameter("resNo");
			String accoNo = (String)request.getParameter("accoNo"); 
			String accoName = (String)request.getParameter("accoName");
	%>
          ...
          <!-- 중간 여백 시작 -->
            ...
            <div class="col-12 d-inline-flex">
                ...
                <div class="col-8">
                    ...
                    <!-- 메인 제목 영역 시작 -->
                    <div>
                        <p class="text-center" style="font-size: 3rem;">리뷰 작성</p>
                    </div>
                    
 				<!-- 메인 제목 영역 끝 -->

                    <!-- 게시판 영역 시작 -->
                <form action="<%=request.getContextPath()%>/acco/review/insert.do"  class="reviewform" method="post">
                    <div class="col-12 d-flex text-center border-3 border-top border-dark pt-3 pb-3">
	            <input type="hidden" name="rate" id="rate" value="0"/>
	            <input type="hidden" name="accoNo" value="<%=accoNo%>">
              ...
              <div class="col-12">리뷰와 별점을 작성해주세요</div>
	            ...
	            <div class="cmd">
	                <input type="submit" value="리뷰 등록" style="float: right;">
	            </div>
	            </div>
	        </form>
