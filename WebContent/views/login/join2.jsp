	...
	<div class="container">
		<div class="input-form-backgroud row">
			<div class="input-form col-md-12 mx-auto">
				...
				<header style="font-size: 2rem" class="text-center p-5">일반 회원가입 👪</header>
					<hr />
				<form class="validation-form" onsubmit="valid()">
				
					<input type="hidden" name="memAth" value="USER" />
					<input type="hidden" name="memCf" value="Y" />
					...
					<div class="row">
						...
						<div class="col-md-2 mb-3 item align-self-end" id="idbtn">
							<button type="button"
								title="Button border lightblue" class="button btnBorder btnLightBlue" style="width: 150px; height: 40px;" id="idChk">중복검사</button>
							<span id="disp"></span>
						</div>
					</div>
         ...
         $.ajax({
            ...
            success :function(result){
               ...
               if(result == 1){
                  ...
                  if(conf) location.href = "/JejuOlleh/views/login/login3.jsp"
 
                  $('#joinspan').text("가입성공").css('color','gold');
                  $('form *').val(""); // 가입 직후 데이터 초기화
