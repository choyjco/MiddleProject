    ...
    <div class="container-fluid">
          ...
          <!-- 메인 커뮤니티 영역 시작 -->
            <div class="col-15 d-inline-flex">
                ...
                <div class="col-8">
                    ...
                    <!-- 메인 제목 영역 시작 -->
                    <div>
                        <p class="text-center" style="font-size: 3rem;">숙소 수정</p>
                    </div>
      ...
      <div class="container">
         <div class="input-form-backgroud row">
            ...
            <form action="<%=request.getContextPath() %>/acco/update.do" method="post" enctype="multipart/form-data">
			<input type="hidden" name="accoNo" value="<%=accoVO.getAccoNo()%>">
			<input type="hidden" name="accoImgNo" value="<%=accoVO.getAccoImgNo()%>">
...
<input type="text" class="form-control" id="accoName" name="accoName" placeholder="<%=accoVO.getAccoName()%>" value="" required>
...
<textarea class="form-control" id="txtbox" name="accoInfo" placeholder="<%=accoVO.getAccoInfo()%>"
...
<div class="row">
	<div class="col-6 mb-3 mt-2"><input type="text" id="kmap" class="form-control" name="accoLoc" placeholder="<%=accoVO.getAccoLoc()%>" readonly required ></div>
	<div class="col-6 mb-3 mt-2"><input type="text" id="addr"  class="form-control" name="accoLoc2"  placeholder="<%=accoVO.getAccoLoc2()%>" required ></div>
...
<div class="row">
	<div class="col-6 mb-3 mt-2"> <input type="text" class="form-control" name="accoPri" placeholder="<%=accoVO.getAccoPri()%>" required ></div>
    ...
    <div class="col-12">
        ...
        <div class="form-check form-check-inline">
            ...
            <label class="form-check-label" for="inlineRadio2">N</label>
               ...
               <input type="submit" value="숙소 수정" style="float: right;">
				</div>
            </form>
</div>
