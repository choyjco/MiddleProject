...
<%
	List<BoardAskVO> boardAskList = (List<BoardAskVO>) request.getAttribute("boardAskList");
// 	List<BoardAnswerVO> boardAnswerList = (List<BoardAnswerVO>) request.getAttribute("boardAnswerList");
// 	out.print("boardAskList : " + boardAskList);
...
<!-- 					<div class="p-3"></div> -->
					<div class="tabcontainer d-flex justify-content-center">
						<div class="ms-5 me-5"><a href="<%=request.getContextPath()%>/boardNot/list.do" >공지사항</a></div>
					...
					<%
						int boardSize = boardAskList.size();
						if (boardSize == 0) {
					%>
					<div>
						<p>문의가 존재하지 않습니다.</p>
					...
					<%
						...
						for (BoardAskVO bav : boardAskList) {
					%>
					<div
						...
						<div class="col-8">
							<a href="./detail.do?askNo=<%=bav.getAskNo()%>"><%=bav.getAskTitle()%></a>
						</div>
					...
					<div class="row">
						<div class="col-12">
							<button type="button" class="btn btn-outline-primary btn-sm"
								id="write"><a href="insert.do">1:1 문의하기</button>
						</div>
					</div>
					<%
						}else{		
