	...
	<div class="col-12 d-inline-flex">
		...
		<!-- 어사이드 영역1 끝 -->
			...
			<div class="col-8">
				...
				<!-- 게시글 수정 영역 시작 -->
				<form action="<%=request.getContextPath()%>/boardFaq/update.do" method="post" enctype="multipart/form-data">
					<input type="hidden" name="faqNo" value="<%=bfv.getFaqNo() %>">
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						<tr>
							<td>제목:</td>
							<td><input type="text" name="faqTitle" value="<%=bfv.getFaqTitle()%>"></td>
						</tr>
						<tr>
							<td>내용:</td>
<%-- 							<td><input type="text" name="notContent" style="width:100%; height:300px;" value="<%=bfv.getFaqContent()%>"></td> --%>
							<td><textarea id="notContent" name="faqContent" rows="10" style="width:100%;"><%=bfv.getFaqContent()%></textarea></td>
						</tr>
					</table>
