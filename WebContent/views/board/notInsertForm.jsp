...
<!-- 					<div class="p-3"></div> -->
					...
					<form action="insert.do" method="post" enctype="multipart/form-data">
						<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
							<tr>
								<td>제목</td>
								<td><input type="text" name="notTitle" value="" style="width:100%;"></td>
							</tr>
							<input type="hidden" name="memId" value="<%=memId1%>">
							<tr>
								<td>내용</td>
<!-- 								<td><input type="text" name="notContent" style="width:100%; height:300px;" value=""></td> -->
								<td><textarea id="notContent" name="notContent" rows="10" style="width:100%;"></textarea></td>
							</tr>
