		...
		<div class="col-8">
			...
			<form action="insert.do" method="post" enctype="multipart/form-data">
				<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
					<tr>
						<td>제목:</td>
						<td><input type="text" name="askTitle" value="" style="width:100%;"></td>
					</tr>
					<tr>
						<td>작성자:</td>
						<td><input type="hidden" name="memId" value="<%=memId1%>"><%=memId1%></td>
					</tr>
					<tr>
						<td>내용:</td>
						<td><input type="text" name="askContent" style="width:100%; height:300px;" value=""></td>
					</tr>
					
				</table>
				<input type="submit" value="문의 등록" style="float: right;">
			</form>
			<!-- 게시글 입력 영역 끝 -->	
