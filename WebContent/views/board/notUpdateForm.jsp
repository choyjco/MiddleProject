	...
	<div class="col-12 d-inline-flex">
		...
		<!-- 어사이드 영역1 끝 -->
			...
			<div class="col-8">
				...
				<!-- 게시글 입력 영역 시작 -->
				<form action="<%=request.getContextPath()%>/boardNot/update.do" method="post" enctype="multipart/form-data">
					<input type="hidden" name="notNo" value="<%=bnv.getNotNo() %>">
					<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
						<tr>
							<td>제목:</td>
							<td><input type="text" name="notTitle" style="width:100%;" value="<%=bnv.getNotTitle()%>"></td>
						</tr>
						<tr>
							<td>내용:</td>
<%-- 							<td><input type="text" name="notContent" style="width:100%; height:300px;" value="<%=bnv.getNotContent()%>"></td> --%>
							<td><textarea id="notContent" name="notContent" rows="10" style="width:100%;"><%=bnv.getNotContent()%></textarea></td>
						</tr>
					</table>
