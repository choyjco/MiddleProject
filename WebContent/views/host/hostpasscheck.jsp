...
<head>
<meta charset="UTF-8">
<title>호스트 회원 정보 수정 - 비밀번호 확인 창</title>
...
<div class="container" style="margin-top:30px">
  <div class="row">
    ...
    <div class="col-sm-8 main-content">
        <form onsubmit="passCheck();" action="<%=request.getContextPath() %>/host/update.do?memId=<%=memId %>" method="post">
		<div class="control-label col-sm-8">
			...
			<br><br>
				...
				<button type="button" class="btn btn-secondary" onclick="location='<%=request.getContextPath() %>/host/mypage.do'" id="canBtn">마이페이지로 이동</button>
			</div>
			</div>
			</div>
        </div>
