...
<%--             <li><a href="<%=request.getContextPath()%>/blacklist/list.do"><b>💙   블랙리스트 관리</b></a></li> --%>
    ...
    <div class="col-sm-8 main-content">
       <form onsubmit="return updateOk()" action="<%=request.getContextPath() %>/admin/updatehost.do" method="post"> <!-- 절대경로 -->
	  <h3 id="he3" style="color:black"><b>🔐호스트 회원 정보 변경🔐</b></h3>
	  <hr>
	    ...
	    <div class="form-group">
	      <label for="hp" class="control-label col-sm-2">🔑   연락처</label>
	        <input type="text" class="col-sm-4" id="hp" name="memHp" value="<%=mv.getMemHp()%>" placeholder="">
	    ...
	    <div class="form-group">
	      <label for="add1" class="control-label col-sm-2">🔑   우편번호</label>
	        <input type="text" class="col-sm-2" id="postAddr" name="memZip" value="<%=mv.getMemZip() %>" placeholder="">
	    ...
	    <div class="form-group">
	      <label for="add1" class="control-label col-sm-2">🔑   주소</label>
	        <input type="text" class="col-sm-6" id="addr1" name="memAdd1" value="<%=mv.getMemAdd1()%>" placeholder="">
	    </div>
	    
	    <div class="form-group">
	      <label for="add2" class="control-label col-sm-2">🔑   상세주소</label>
	        <input type="text" class="col-sm-6" id="addr2" name="memAdd2" value="<%=mv.getMemAdd2()%>" placeholder="">
	    </div>
	    
	     <div class="form-group">
	      <label for="cf" class="control-label col-sm-2">🔑   승인 여부</label>
	        <input type="radio" class="col-sm-1" id="cfN" name="memCf" value="N" <% if (mv.getMemCf().equals("N")) { %>checked<% } %>>N
   			<input type="radio" class="col-sm-1" id="cfY" name="memCf" value="Y" <% if (mv.getMemCf().equals("Y")) { %>checked<% } %>>Y
	    </div>
	    ...
	    <div class="form-group">
            <div align="center">
                ...
                <button type="button" class="btn btn-secondary" id="canBtn" onclick="location='<%=request.getContextPath() %>/admin/hostlist.do'">취소</button>
            </div>
	      </div>
	    </div>
    </form>
