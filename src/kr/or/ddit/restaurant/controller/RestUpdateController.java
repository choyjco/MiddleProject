...
@MultipartConfig
@WebServlet("/RestUpdateController")
public class RestUpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    RestaurantVO vo = restaurantImgService.detailRestaurant(rstNo);
	    
	    req.setAttribute("restaurantVO", vo);
	    
		RequestDispatcher rd = req.getRequestDispatcher("/views/restaurant/restupdate.jsp");
