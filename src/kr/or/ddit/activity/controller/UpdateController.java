...
public class UpdateController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    ActivityVO vo = activityImgService.detailActivity(actNo);
	    
	    req.setAttribute("activityVO", vo);
	    
		RequestDispatcher rd = req.getRequestDispatcher("/views/activity/actupdate.jsp");
	   ...
	   protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		 ...
		 // String actImgPath = req.getParameter("actImgPath");
		  ...
		  int len;
	        ...
	        int cnt = activityImgService.updateActivity(activityVO);
