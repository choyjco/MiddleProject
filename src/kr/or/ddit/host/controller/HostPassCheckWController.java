...
@WebServlet("/host/hostpasscheckw.do")
public class HostPassCheckWController extends HttpServlet {

	public HostPassCheckWController() {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if(session.getAttribute("memId")!=null) {
			...
			RequestDispatcher rd = req.getRequestDispatcher("/views/host/hostpasscheckw.jsp");
			rd.forward(req, resp);
